...
func (_m *UserUsecase) Create(user domain.User) (domain.User, error) {
	ret := _m.Called(user)
...
func (_m *UserUsecase) Login(user domain.User) (bool, error) {
	ret := _m.Called(user)
...
func (_m *UserUsecase) Validate(user *domain.User) (bool, error) {
	ret := _m.Called(user)
